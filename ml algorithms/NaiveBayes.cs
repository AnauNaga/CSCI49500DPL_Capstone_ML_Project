...
namespace Master
{
  public class NaiveBayes
  {
    ...
    public int[] totalCorrectPerCategory = new int[5];
    public int[] totalAttemptsPerCategory = new int[5];

    public Dictionary<string, double[]> probabilityTable = new Dictionary<string, double[]>();
    ...
    public List<double> categoryTotalWordCount;
    public Dictionary<string, int> categoryCount = new Dictionary<string, int>();
    public double trainingDataCount = 0;
    public Dictionary<string, int> categoryOrder = new Dictionary<string, int>();


    public void learnData(List<string> answers, List<List<string>> trainingData)
    {
    ...
    public string estimateData(List<string> data)
    {
